...
public class PseudoFormatter extends AbstractDeclarativeFormatter {
  ...
  protected void configureFormatting(FormattingConfig c) {
    ...
    c.setIndentationIncrement().before(grammar.getWhenExpressionAccess().getActionsExpressionLevel3ParserRuleCall_0_3_0());
    c.setIndentationDecrement().after(grammar.getWhenExpressionAccess().getActionsExpressionLevel3ParserRuleCall_0_3_0());
    c.setIndentationIncrement().before(grammar.getWhenExpressionAccess().getDefaultActionExpressionLevel3ParserRuleCall_1_1_0());
    c.setIndentationDecrement().after(grammar.getWhenExpressionAccess().getDefaultActionExpressionLevel3ParserRuleCall_1_1_0());
    ...
    c.setIndentationDecrement().before(grammar.getMethodAccess().getEND_TOKENParserRuleCall_5());
